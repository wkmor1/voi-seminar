...
---
# Informal VOI in Spatial Conservation Planning

--
- .font120[Comparison of data quantity (full species occurrence dataset vs. subset)]

--
- .font120[Comparison of data quality (fine resolution data vs. coarse)]

--
- .font120[Span a wide range systems ()]
...
$\mathrm{EVPI} = \mathrm{EVWPI} - \max_a\mathrm{E}_s[v(a,s)]$
...
$\mathrm{EVPI} = \mathrm{E}_s\max_a[v(a,s)] -$ .red[6%]
...
$\mathrm{EVPI} = \mathrm{E}_s$(.blue[7%], .blue[7%]) - .red[6%]
