...
If I talk too quietly let me know.

Feel free to ask questions during talk if anything doesnt make sense.
...
So today I'm going to talk about a narrow but important part of decision science. The value of information, or VOI. 

Can be thought of as both a rigidly defined set of formal tools used in decision analysis, but also as a more broad philosophy about how to think about information and learning in the context of decision making.
...
Either way, Value of Information presupposes that information has some finite value that can be compared and contrasted with the cost of information, and also the payoffs and losses resulting from the ultimate decision itself. Really all 
'value of information' is, in a way, is an implicit acknowledgement of the decisioness of investing in learning and all the tools we have to assess ahead of time how to make a good decision can be applied to learning.
...
So with this in mind VOI can be used to tell the decision maker whether it is worth seeking new information how much new information is needed and what form that new information should take.
...
This in implies that there two types of information in the context of decision making critical information and non-critical. Where critical information has the ability to change the decision made and the value of its outcome. non-critical information does not change the decision made regardless of its content and by definition has no value.
